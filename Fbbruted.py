...
def iqbalz(iqbalz_password):
  ...
  try:
 	...
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m IS BRUTEFORCED BY THIS PASS==> \033[91m[\033[90;1m"+iqbalz_password)	sys.stdout.flush()
...
def runn_noobs():
         ...
         lop = GG+"""figlet "LEBANON CYBER" | lolcat -F 1000\033[91;1m
